...
int rlua::lua_newthread(int thread)
{
	...
	case ETERNALBYPASS_DEF:
		return reinterpret_cast<lua::lua_newthread_def>(eternal_unprotect(RLUA_NEWTHREAD_ADDR))(thread);
	case BRANDONBYPASS_DEF:
		return reinterpret_cast<lua::lua_newthread_def>(brandon_retcheck::retcheckunprotect(RLUA_NEWTHREAD_ADDR))(thread);
	case JBRRBYPASS_DEF:
	{
...
int rlua::lua_getfield(int a2, const char* a3)
{
	...
	case ETERNALBYPASS_DEF:
	{
		return reinterpret_cast<lua::lua_getfield_def>(eternal_unprotect(RLUA_GETFIELD_ADDR))(state, a2, a3);
	}
	case BRANDONBYPASS_DEF:
		return reinterpret_cast<lua::lua_getfield_def>(brandon_retcheck::retcheckunprotect(RLUA_GETFIELD_ADDR))(state, a2, a3);
	case JBRRBYPASS_DEF:
	{
...
int rlua::lua_pushstring(const char* a2)
{
	...
	case ETERNALBYPASS_DEF:
	{
		return reinterpret_cast<lua::lua_pushstring_def>(eternal_unprotect(RLUA_PUSHSTRING_ADDR))(state, a2);
	}
	case BRANDONBYPASS_DEF:
		return reinterpret_cast<lua::lua_pushstring_def>(brandon_retcheck::retcheckunprotect(RLUA_PUSHSTRING_ADDR))(state, a2);
	case JBRRBYPASS_DEF:
	{
...
int rlua::lua_pushnumber(double a2)
{
	...
	{
	case ETERNALBYPASS_DEF:
		return reinterpret_cast<lua::lua_pushnumber_def>(eternal_unprotect(RLUA_PUSHNUMBER_ADDR))(state, a2);
	case BRANDONBYPASS_DEF:
		return reinterpret_cast<lua::lua_pushnumber_def>(brandon_retcheck::retcheckunprotect(RLUA_PUSHNUMBER_ADDR))(state, a2);
	case JBRRBYPASS_DEF:
	{
...
int rlua::lua_pushboolean(bool a2)
{
	...
	{
	case ETERNALBYPASS_DEF:
		return reinterpret_cast<lua::lua_pushboolean_def>(eternal_unprotect(RLUA_PUSHBOOLEAN_ADDR))(state, a2);
	case BRANDONBYPASS_DEF:
		return reinterpret_cast<lua::lua_pushboolean_def>(brandon_retcheck::retcheckunprotect(RLUA_PUSHBOOLEAN_ADDR))(state, a2);
	case JBRRBYPASS_DEF:
	{
...
int rlua::lua_pcall(int a2, int a3, int a4)
{
	...
	case ETERNALBYPASS_DEF:
	{
		return reinterpret_cast<lua::lua_pcall_def>(eternal_unprotect(RLUA_PCALL_ADDR))(state, a2, a3, a4);
	}
	case BRANDONBYPASS_DEF:
		
		return reinterpret_cast<lua::lua_pcall_def>(brandon_retcheck::retcheckunprotect(RLUA_PCALL_ADDR))(state, a2, a3, a4);
	case JBRRBYPASS_DEF:
	{
